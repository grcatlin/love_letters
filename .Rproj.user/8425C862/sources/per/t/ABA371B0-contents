# GC NOTE: script and data from https://www.census.gov/programs-surveys/decennial-census/about/rdo/summary-files.html #

# -----------------------------
# Import the data
# -----------------------------
header <- read.delim("cens_files/wygeo2020.pl", header=FALSE, colClasses="character", sep="|")
part1  <- read.delim("cens_files/wy000012020.pl",  header=FALSE, colClasses="character", sep="|")
part2  <- read.delim("cens_files/wy000022020.pl",  header=FALSE, colClasses="character", sep="|")
part3  <- read.delim("cens_files/wy000032020.pl",  header=FALSE, colClasses="character", sep="|")
...
saveRDS(combine, "R_Objects/cens_import.rds")
